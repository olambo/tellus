...
**50m average depth** — permanent thermal stratification, evaporation defeat, drought resilience.
**Volume: 5 km³ per node.**
**Water surface: 100 km² per node.**
**No dam wall** — natural terrain containment on three sides, managed eastern interface.
**Water positive** — 0.2 km³/year evaporation against 0.3+ km³/year inflow from node above and local catchment.
